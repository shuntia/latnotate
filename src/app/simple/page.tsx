  ...
  return (
    <>
      ...
      <div className="mt-4 pb-20">
        {tokens === null || edited ? (
          <textarea
            className="w-full min-h-[60vh] resize-none outline-none border-none ring-0 focus:ring-0 text-gray-800 text-lg leading-relaxed bg-transparent placeholder-gray-300 p-0"
          ...
          <div className="text-gray-800 text-lg leading-relaxed break-words whitespace-pre-wrap">
            {tokens.map((token, i) => {
              const key = stripPunctuation(token);
              ...
              return (
                <span
                  ...
                  className={
                    hasEntry
                      ? `cursor-pointer transition-colors ${isSelected ? "text-black font-medium" : "text-gray-800 hover:text-black"}`
                      : undefined
                  }
                >
                  {token}
      ...
      {/* Look up / Edit button — fixed bottom right */}
      ...
      {sidebarOpen && (
        <div className="fixed top-0 right-0 h-full w-80 bg-white border-l border-gray-100 z-30 flex flex-col shadow-sm">
          <div className="flex items-center justify-between px-5 py-4 border-b border-gray-100 mt-14">
